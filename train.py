...
from methods.protonet_ours import ProtoNet_Ours
...
if __name__=='__main__':
    ...
    if params.method in ['baseline', 'baseline++'] :
    ...
    elif params.method in ['relationnet_ours', 'protonet_ours', 'protonet','matchingnet','relationnet', 'relationnet_softmax', 'maml', 'maml_approx']:
        ...
        elif params.method == 'protonet_ours':
            model           = ProtoNet_Ours( model_dict[params.model], **train_few_shot_params )
